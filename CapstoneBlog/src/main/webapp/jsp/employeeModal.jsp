...
<input type="hidden" id="body">
    ...
    <input type="hidden" id="activeStatus" name="activeStatus" value="3">
   

        
    
Select posting date:<br>
    <input type="date" name="postDate" id="postDate" value=""/><br>
  ...
  <!--  <div class="row">-->
    <div id="buttonDiv">
    <button  type="submit" id="postButton2" class="btn btn-default" data-dismiss="modal">Submit</button>
</div><!--buttonDiv-->
