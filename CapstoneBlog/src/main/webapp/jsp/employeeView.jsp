        ...
        <div class="container-fluid"  id="dots">
            ...
            <div class="container-fluid" id="contain">
                ...
                <div class="row">
                    ...
                    <br>
                    <br><br>
                    <div class="col-sm-7" id="theform">    <div id="inputDiv"><%@include file="employeeInput.jsp" %></div></div>
            ...
            <nav class="navbar navbar-default navbar-fixed-bottom" id="blogNav">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li role="presentation"><a href="${pageContext.request.contextPath}/home">Admin Page</a></li>
